...
const Index = () => {
  ...
  return (
    <nav
      className={
        "px-15 bg-[#F1F3F6] pt-12 relative before:absolute before:h-full before:w-[60px] before:content-[attr(before)] before:bg-[#F1F3F6]  before:bottom-0 before:left-0 before:z-[90]  before:rounded-br-xl after:absolute after:h-full after:w-[60px] after:content-[attr(after)] after:bg-[#F1F3F6]  after:bottom-0 after:right-0 after:z-10 after:rounded-bl-xl"
      }
    >
      <ul className={"flex justify-between"}>
        {map(tabs, (tab, index) => (
          ...
          >
            <div
              className={clsx(
                isEqual(index, activeTab) ? "bg-primary-blue" : "bg-gray-300",
