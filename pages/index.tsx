...
const Index = () => {
  return (
    <GuestLayout>
      ...
      {/*    <Card*/}
      {/*      className={*/}
      {/*        "absolute  right-15 -bottom-full -translate-y-3/4 p-[50px]"*/}
      {/*      }*/}
      {/*    >*/}
      {/*      <h3*/}
      {/*        className={"font-semibold font-inter text-lg max-w-[200px] mb-14"}*/}
      {/*      >*/}
      ...
      {/*    <div className={"col-span-4"}>*/}
      {/*      <Card className={"relative"}>*/}
      {/*        <Image src={newsThree} alt={"new Image"} layout={"responsive"} />*/}
      {/*      </Card>*/}
      {/*      <h3*/}
      {/*        className={*/}
      {/*          "text-[25px] font-graphik font-semibold leading-[35px] my-6"*/}
